...
const MySubscriptionRoute = MySubscriptionRouteImport.update({ id: '/my-subscription', path: '/my-subscription', getParentRoute: () => rootRouteImport } as any)
...
const SevasRoute = SevasRouteImport.update({ id: '/sevas', path: '/sevas', getParentRoute: () => rootRouteImport } as any)
const IndexRoute = IndexRouteImport.update({ id: '/', path: '/', getParentRoute: () => rootRouteImport } as any)
const PlanPlanIdRoute = PlanPlanIdRouteImport.update({ id: '/plan/$planId', path: '/plan/$planId', getParentRoute: () => rootRouteImport } as any)
const CheckoutPlanIdRoute = CheckoutPlanIdRouteImport.update({ id: '/checkout/$planId', path: '/checkout/$planId', getParentRoute: () => rootRouteImport } as any)
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/about' | '/faq' | '/my-subscription' | '/plans' | '/profile' | '/reviews' | '/sevas' | '/checkout/$planId' | '/plan/$planId'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/about' | '/faq' | '/my-subscription' | '/plans' | '/profile' | '/reviews' | '/sevas' | '/checkout/$planId' | '/plan/$planId'
  id: '__root__' | '/' | '/about' | '/faq' | '/my-subscription' | '/plans' | '/profile' | '/reviews' | '/sevas' | '/checkout/$planId' | '/plan/$planId'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/my-subscription': { id: '/my-subscription'; path: '/my-subscription'; fullPath: '/my-subscription'; preLoaderRoute: typeof MySubscriptionRouteImport; parentRoute: typeof rootRouteImport }
    ...
    '/sevas': { id: '/sevas'; path: '/sevas'; fullPath: '/sevas'; preLoaderRoute: typeof SevasRouteImport; parentRoute: typeof rootRouteImport }
    '/': { id: '/'; path: '/'; fullPath: '/'; preLoaderRoute: typeof IndexRouteImport; parentRoute: typeof rootRouteImport }
    '/plan/$planId': { id: '/plan/$planId'; path: '/plan/$planId'; fullPath: '/plan/$planId'; preLoaderRoute: typeof PlanPlanIdRouteImport; parentRoute: typeof rootRouteImport }
    '/checkout/$planId': { id: '/checkout/$planId'; path: '/checkout/$planId'; fullPath: '/checkout/$planId'; preLoaderRoute: typeof CheckoutPlanIdRouteImport; parentRoute: typeof rootRouteImport }
  }
}
