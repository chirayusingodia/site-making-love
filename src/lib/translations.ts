...
export const translations = {
  hindi: {
    ...
    pm_ques_1: "5 sadhu-santon ko bhojan (Brahmin Bhojan) — vedic sankalp sahit",
    ...
    pm_cta: "Punya Bank Shuru Karein — See Plans",
  ...
  english: {
    ...
    pm_ques_1: "Feeding 5 sadhus (Brahmin Bhojan) — with Vedic Sankalp",
    ...
    pm_cta: "Start Punya Bank — See Plans",
